        ...
        public async Task<Response> GetCatalogs()
        {
            ...
            try
            {
                ...
                CatalogModelList catalogs = new CatalogModelList
                {
                    ...
                    Indirects = Indirects.Select(p => new CatalogIndirectModel { 
                        Id = p.PoliticaViaticosId,
                        Concept = p.Concepto, 
                        UnitId = p.UnidadMedidaId, 
                        Unit = p.Medida, 
                        ZoneId = p.ZonaId, 
                        Zone = p.Zona, 
                        Cost = p.Monto, 
                        IsMandatory = p.EsObligatorio, 
                        IsOptionalMandatory = p.EsObligatorioOpcional, 
                        LocationId = p.UbicacionId, 
                        Location = p.Ubicacion, 
                        RoundingId = p.RedondeoId, 
                        Rounding = p.Redondeo, 
                        Base = p.Base, 
